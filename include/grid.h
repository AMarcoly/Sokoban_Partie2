...
struct Grid{
	...
	//PointTab pointtab;//< tableau avec les coordonnees des points
	int nbr_de_cibles;///< Nombre de points cibles a recouvrir
	int pts_cibles_recouverts;///< Nombre de points ciles recouverts
};
...
/**
 * @brief fonction verifiant si deux points sont egaux
 * 
 * @param grid 
 * @return int 
 */
